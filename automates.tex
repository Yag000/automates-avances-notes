...
\knowledge{R-préordre}[Rprefixe]{notion}
\knowledge{L-préordre}[Lsuffix]{notion}
\knowledge{J-préordre}[Jinfix]{notion}
\knowledge{$R$-équivalent}[classR|$R$-classe]{notion}
\knowledge{$L$-équivalent}[classL|$L$-classe]{notion}
\knowledge{$J$-équivalent}[classJ|$J$-classe]{notion}
\knowledge{$H$-classe}[classH]{notion}
