...
\begin{prop}
	...
	et  $\mirror A = \detA (\mirr(A)) $ est l'automate obtenu en déterminisant l'automate miroir de $A$. Alors
...
\begin{proof}
	...
	Soit $p$ un état de $T u$. Puisque $A$ est accesible, il existe un chemin de $q_0 \to p$ dans $A$, donc il existe un chemin $p \to q_o$ dans $\mirr(A)$.
